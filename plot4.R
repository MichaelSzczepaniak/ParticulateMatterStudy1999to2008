...
# to my coal indices, however, this only added 2 add'l indices: 9061, 9062 and
...
g <- ggplot(emissionsCombined, aes(x = Year, y = log10(Total_Emissions),
...
plot <- plot + labs(y = expression(Log[10] * (PM[2.5] * " Emissions" * " (in tons)")))
